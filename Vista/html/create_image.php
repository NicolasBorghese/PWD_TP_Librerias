...
/*Usa un operador ternario, si no está seteado el arreglo $_GET['s'] le asigna un valor por default
a $setting */
$setting = isset($_GET['s']) ? $_GET['s'] : "FFF_111_100_100";

//Separa un string en base a un separador indicado y crea un arreglo compuesto por esos elementos
...
switch ($n = count($setting)) {
    ...
    case 2:
        ...
        break;
    default:
        //Completa por defecto los valores del arreglo $img si no se ingresaron datos
...
/*Usa un operador ternario, si no está seteado el arreglo $_GET['t'] le asigna un valor por default
a $string */
